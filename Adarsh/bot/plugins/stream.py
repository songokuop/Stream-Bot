    ...
    if Var.UPDATES_CHANNEL != "None":
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=m.chat.id,
                    text="You are banned!\n\n  **Contact Developer [OWNER](https://telegram.me/Movies_Zone_Contact_Bot) he will help you.**",
            ...
            await c.send_message(
                chat_id=m.chat.id,
                text="**sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [ʙᴏss](https://telegram.me/Movies_Zone_Contact_Bot)**",
...
<b>❇️  ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @mOVIES_ZONE_MEDIA</b>"""
        ...
        await m.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton('🎪  ꜱᴜʙꜱᴄʀɪʙᴇ ᴍʏ ʏᴛ ᴄʜᴀɴɴᴇʟ  🎪', url='https://telegram.me/Movies_Zone_Media')]])
        )
